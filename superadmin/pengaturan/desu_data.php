      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Deskripsi Super Admin</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Deskripsi Super Admin</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $i++;?></td>
                    <td><?php echo $data['des_superadmin'];?></td>
                    <td align="center">
                      <a href="index.php?menu=Edit_Deskripsi_Superadmin&id=<?php echo $data['id'];?>" class="btn btn-flat btn-success open-modal"><i class="fa fa-edit"></i> Ubah</button>
                    </td>
                  </tr>
