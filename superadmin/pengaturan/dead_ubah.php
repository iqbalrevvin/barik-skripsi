<?php
  ...
  $dataDeskripsi = isset($_POST['Txt_Deskripsi']) ? $_POST['Txt_Deskripsi'] : $data['des_admin'];
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="index.php?menu=Desk_Utama"><i class="fa fa-file"></i> Deskripsi Admin</a></li>
            ...
            <section class="content">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ubah Deskripsi Admin</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="Txt_Deskripsi" name="Txt_Deskripsi" placeholder="Masukkan Deskripsi Disini..." style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $dataDeskripsi;?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
            ...
            <?php
                if(isset($_POST['Tb_Simpan'])){
                  ...
                  if (trim($TxtDeskripsi)=="") {
                    ...
                    $mySql	= "UPDATE tbl_deskripsi SET des_admin = '$TxtDeskripsi' WHERE id = '$id'";

                		$myQry	= mysql_query($mySql, $koneksi) or die ("Gagal query".mysql_error());
                		
                		echo "<meta http-equiv='refresh' content='0; url=index.php?menu=Desk_Admin&pesan=success&isi=1'>";
                		exit;
                	}
                }
            ?>
