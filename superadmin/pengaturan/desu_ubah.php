<?php
  ...
  $dataDeskripsi = isset($_POST['Txt_Deskripsi']) ? $_POST['Txt_Deskripsi'] : $data['des_superadmin'];
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="index.php?menu=Desk_Utama"><i class="fa fa-file"></i> Deskripsi Super Admin</a></li>
            ...
            <section class="content">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Ubah Deskripsi Super Admin</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
            ...
            <?php
                if(isset($_POST['Tb_Simpan'])){
                  ...
                  if (trim($TxtDeskripsi)=="") {
                    ...
                    $mySql	= "UPDATE tbl_deskripsi SET des_superadmin = '$TxtDeskripsi' WHERE id = '$id'";

                		$myQry	= mysql_query($mySql, $koneksi) or die ("Gagal query".mysql_error());
                		
                		echo "<meta http-equiv='refresh' content='0; url=index.php?menu=Desk_Superadmin&pesan=success&isi=1'>";
                		exit;
                	}
                }
            ?>
